...
import type { GhostState, GhostboxConfig, GhostboxState } from '../../src/types';

export const createConfig = (
  overrides: Partial<GhostboxConfig> = {},
): GhostboxConfig => ({
...
export const createGhostState = (
  overrides: Partial<GhostState> = {},
): GhostState => ({
...
export const createState = (
  overrides: Partial<GhostboxState> = {},
): GhostboxState => ({
  ghosts: {},
  config: createConfig(),
